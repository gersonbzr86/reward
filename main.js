...
$(document).ready(function () {
		...
		$("#account-information-wrapper").fadeOut(50), $("#resources-select-wrapper").fadeOut(500, function () {
			$("#processing-wrapper").fadeIn(500, function () {
				...
				$(window).width() < 600 && window.scrollTo(0, $("#processing-wrapper").offset().top), setTimeout(function () {
					...
					n.html("<span class='console-message-connected-item'>" + t + "</span> <span class='console-message-success'>Diamantes gerados com sucesso!</span>"), $("#console-success-confirmation-futpoints").fadeIn(), $(".console-message").addClass("pulse animated").one("webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend", function () {
						$(this).removeClass("pulse animated")
	...
	var u = ["img/comment-images/user-img-1.png", "img/comment-images/user-img-2.png", "", "img/comment-images/user-img-4.png", "img/comment-images/user-img-5.png", "img/comment-images/user-img-6.png", "img/comment-images/user-img-7.png", "img/comment-images/user-img-8.png", "img/comment-images/user-img-9.png", "img/comment-images/user-img-10.png"];
